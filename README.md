...
![](screenshots\01-MainMenu.png)
3. Note Trainer for note training.
    - Set the number of seconds per trial and the number of total trials you want to use. 
    - You will be told (via text and my voice) to play a specific note on a specific string in a specific position. ![](screenshots\02a-NoteTrainerMain1.png)
    - After the number of seconds specified earlier, you will be see (and be told by my voice) if you played the correct or incorrect note. If incorrect, you will be told which note you played (audio of my voice and in console log). ![](screenshots\05-ConsoleLog.png)
    - At the end of all trials, you will see how many you got incorrect. Your progress is also tracked by the white, green, and red indicators on the screen. ![](screenshots\04-NoteTrainerMissedNotes.png)
4. 'High scores' shows you your best games for each `Trials: X | Time per trial: Y` combination. ![](screenshots\03-NoteTrainerHighScore.png)
5. 'Most incorrect notes' shows you a bar chart of your most commonly missed notes. ![](screenshots/04-NoteTrainerMissedNotes.png)